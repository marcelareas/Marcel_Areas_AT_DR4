package br.edu.infnet.marcel.usuario.domain;
...
@Entity
@Table(name = "Usuario", catalog = "mysqldb", schema = "", uniqueConstraints = {
...
public class Usuario implements Serializable {
    ...
    public String toString() {
        return "br.edu.infnet.marcel.usuario.domain.Usuario[ id = " + id + " ]";
    }
